    ...
    <>
        ...
        <div className="mt-16">
          <form action="">
            ...
            <div className="mb-3"> 
                <label>by continuing, you agree to our terms of service</label>
            </div>
        ...
        <div className="flex justify-center">
          <a className="text-primary text-sm font-bold">Already have account ? </a>
        </div>
        {/* link end */}
    </>
  )
