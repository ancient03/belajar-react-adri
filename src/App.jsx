        ...
        {courses.map((course, index) => (
          <div key={index} 
            className="shadow rounded-lg overflow-hidden flex flex-col 
                    hover:border-gray-500 hover:shadow-lg hover-scale-105 transition-transform duration-300"
          >
            {/* Image */}
            <img
            ...
            <div className="p-4 bg-red-100 flex flex-col justify-between h-full">
              ...
              <div className="bg-red-50 p-2 rounded-lg">
                ...
                {/* Author */}
                <div className="flex item-center mt-3 mb-2 gap-2">
                  <img
              ...
              {/* Footer */}
              <div className="mt-4">
                <div className="flex item-center bg-white py-2 px-4 rounded">$123</div>
